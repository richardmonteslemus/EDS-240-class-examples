...
ca_region |> 
  ...
  scale_x_continuous(limits = c(0, 0.6)) # Expand x axis to make a little more space for it 
```
...
ggplot(ca_region, aes(x = subregion_name)) + 
  geom_bar() + 
  coord_flip() + 
  scale_y_continuous(label = label_comma()) # Make sure to apply to axis position before coord_flip
```
...
sui_severity <- ca_region |>
  ...
  mutate(sui_category = factor(sui_category, levels =c("Very low", "Low", "Moderate", "High")))
```
...
ggplot(sui_severity, aes(x = month, y = tot_num_sui, fill = sui_category)) + 
  ...
  scale_fill_manual(values = sui_colors) + scale_y_continuous(labels = label_percent())
...
#| echo: false
#.........................create heatmap.........................
ggplot(heat_map_order, aes(x = year, y = subregion_name, fill = annual_mean_sui)) +
  geom_tile() + 
  scale_fill_viridis_c() + 
  scale_x_continuous(breaks = seq(2010, 2020, by = 2)) + 
  labs(fill = "Annual Mean Surface Water\n Supply and Use Index (SUI)") +
