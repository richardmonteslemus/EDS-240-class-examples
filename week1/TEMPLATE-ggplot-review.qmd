...
ggplot(penguins, aes(x = bill_length_mm, y = bill_depth_mm, color = body_mass_g)) + 
  geom_point() + 
  scale_color_continuous(low = "#F7DD4C", high = "green4")
```
...
ggplot(penguins, aes(x = species)) + 
  geom_bar(stat = "count") # Stat is the default but you can change it 
```
...
#.......................position functions.......................
ggplot(penguins, aes(x = species, fill = island)) +
  geom_bar(position = position_dodge2(preserve = "single")) # all bars of equal width
```
...
ggplot(penguins, aes(x = flipper_length_mm, fill = species)) + 
  ...
  labs(x = "Flipper Length (mm)", 
       y = "Frequency", 
       fill = "Species", 
       title = "Penguins Flipper Lengths") + 
...
p1 + (p2/p3) + 
  plot_annotation(title = "All the Greatest Penguin Plots")
```
