...
joined_precip_geom <- full_join(county_geo_wrangled, precip_wrangled)  # Simple feature goes first 
```
...
my_brewer_pallette11 <- RColorBrewer::brewer.pal(n = 11, name = 'BrBG')
```
...
base_map + 
  scale_fill_gradientn(colors = my_brewer_pallette11,
